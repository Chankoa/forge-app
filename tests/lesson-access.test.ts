...
test("owner can preview without enrollment and learner cannot claim owner preview", () => { assert.equal(canAccessLessonMode(owner, "preview"), true); assert.equal(canAccessLessonMode(enrolled, "preview"), false); });
